    ...
    <div class="container-fluid">
        <div class="wrap cf">
            ...
            <div class="heading cf">
              ...
              <div class="btn-div">
                    <a href="store.php" class="continue" style="margin-top: 10px;" >Continue Shopping</a>
              </div>
            </div>
            <div class="cart">
                <ul class="cartWrap">
                                ...
                                echo '<li class="items even">
                                    <div class="infoWrap"> 
                                        ...
                                        <div class="cartSection invoiceWrap">
                                            <button class="invoiceButton" onclick="showInvoice('.$order_id.')  " style="border-radius: 13px;border-color: #82ca9c;background: #82ca9c;color: white;" >Invoice</button>
                                        </div>
                                    </div>
                                </li>';
                            } else {
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            if ($prev_old == 0 || $prev_old == $order_id) {
                                ...
                                echo '</ul></div><div class="special"><div class="specialContent">Thanks for Using our Platform</div></div><div class="subtotal cf"><ul>
                                        ...
                                        <div class="cartSection invoiceWrap">
                                            <button class="invoiceButton" onclick="showInvoice('.$order_id.')" style="" >Invoice</button>
                                        </div>
                                    </div>
                                </li>';
                                $prev_total = $total_amt;
...
<style>
    .invoiceButton
    {
        border-radius: 13px;border-color: #82ca9c;background: #82ca9c;color: white;
    }
    .print-btn
    {
        border-radius: 13px;border-color: #82ca9c;background: #82ca9c;color: white; 
