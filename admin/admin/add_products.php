            ...
            <div class="card">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <select id="product_type" name="product_type" class="form-control" required style=" color: white; " >
                        <?php
                        ...
                        if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                              echo '<option value="' . $row['cat_id'] . '" style="color: black;">' . $row['cat_title'] . '</option>';
                    ...
                    <select id="product_type" name="brand" id="brand" class="form-control" required style=" color: white; " >
                        <?php
                        ...
                        if ($result) {
                            while ($row = mysqli_fetch_assoc($result)) {
                              echo '<option value="' . $row['brand_id'] . '" style="color: black;">' . $row['brand_title'] . '</option>';
