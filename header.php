			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="#"><i class="fa fa-envelope-o"></i> awais@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i>Taxila</a></li>
					</ul>
					<ul class="header-links pull-right">
						<li><a href="#"><i ></i> PKR</a></li>
						<li><?php
							...
							<div class="header-search">
								<form onsubmit="return false" style="display: flex;" >
									<?php
										...
										if ($result) {
											echo '<select class="input-select" style="color: black;">'; 
			...
			<div class="container" id="get_category_home">
				 <div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active" cid="1"><a href="store.php">Electronics</a></li>
